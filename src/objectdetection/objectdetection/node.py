...
from foxglove_msgs.msg import TextAnnotation, Point2, Color, ImageAnnotations, PointsAnnotation
...
class ObjectDetectionNode(Node):
    def __init__(self, min_bbox_area=400, min_bbox_side=25, debug=False):
        ...
        self.publisher_ = self.create_publisher(ImageAnnotations, '/d455_1_rgb_image/detected_objects', 10) # was: Detections, Detection2DArray, ImageMarkerArray
        ...
        self.model = YOLOv3(min_bbox_area=400, min_bbox_side=20, debug=self.debug)
    ...
    def listener_callback(self, msg):
        ...
        if len(boxes)>0:
            ...
            for box, conf, class_name, class_id in zip(boxes, confidences, class_names, class_ids):
                ...
                img_annotations.points.append(
                    PointsAnnotation(
                        ...
                        outline_color=Color(a=1., b=b, g=g, r=r),
                ...
                img_annotations.texts.append(
                    TextAnnotation(
                        ...
                        text_color=Color(a=1., b=b, g=g, r=r),
                        background_color=Color(a=0., b=b, g=g, r=r)
                    )
                )
            ...
            img_annotations.texts.append(
                TextAnnotation(
                    ...
                    text_color=Color(a=0., b=0., g=0., r=0.),
                )
            )
...
def main():
    ...
    rclpy.init()
    node = ObjectDetectionNode(min_bbox_area=400, min_bbox_side=25, debug=False)
    rclpy.spin(node)
